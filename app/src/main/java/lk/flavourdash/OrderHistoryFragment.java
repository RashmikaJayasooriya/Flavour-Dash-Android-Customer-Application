...
public class OrderHistoryFragment extends Fragment {
    ...
    private void setupFirestoreListenerForOrders() {
        firebaseFirestore.collection("Orders").whereEqualTo("userId",userDocumentId ).whereIn("orderStatus", Arrays.asList("Delivered", "Rejected")).addSnapshotListener((value, error) -> {
            if (error != null) {
        ...
        firebaseFirestore.collection("Orders").whereEqualTo("userId",userDocumentId ).whereIn("orderStatus", Arrays.asList("Accept", "Reject")).addSnapshotListener((value, error) -> {
            if (error != null) {
                Log.e(TAG, "Error getting documents: ", error);
                return;
            }
